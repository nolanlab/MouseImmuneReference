...
Download the data file available [here](http://www.cytobank.org/nolanlab/reports/Spitzer2015.html) and save it anywhere on your computer (This is the .scaffold file that is mentioned on the webpage at the above link). Launch the MouseImmuneReference GUI by typing the following commands in an R session
